...
class CicadaScoreCaOverNight(CicadaAnalysis):
    def __init__(self, config_handler=None):
        ...
        CicadaAnalysis.__init__(self, name="Cell assembly score over night", family_id="Descriptive",
    ...
    def set_arguments_for_gui(self):
        ...
        for session_data in self._data_to_analyse:
            ...
            # TODO: Add option to select group of sleep_stage using text LineEdit group
    ...
    def run_analysis(self, **kwargs):
        ...
        for session_index, session_data in enumerate(self._data_to_analyse):
            ...
            slep_stage_text_selection = kwargs.get(f"sleep_stages_selected_by_text_{session_identifier}", "")
            sleep_stages_selected = []
            if validate_indices_in_string_format(slep_stage_text_selection):
                sleep_stages_selected = extract_indices_from_string(slep_stage_text_selection)
